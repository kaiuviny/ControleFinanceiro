...
-- -----------------------------------------------------
-- Table `ControleFinanceiro`.`telefone`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ControleFinanceiro`.`telefone` (
  `id_telefone` INT NOT NULL AUTO_INCREMENT,
  `numero_celular` INT(12) NOT NULL,
...
-- -----------------------------------------------------
-- Table `ControleFinanceiro`.`endereco`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ControleFinanceiro`.`endereco` (
...
-- -----------------------------------------------------
-- Table `ControleFinanceiro`.`tipo_pessoa`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ControleFinanceiro`.`tipo_pessoa` (
  `id_tipo_pessoa` INT NOT NULL AUTO_INCREMENT,
  `tipo_pessoa` ENUM('FISICA', 'JURIDICA') NULL,
...
-- -----------------------------------------------------
-- Table `ControleFinanceiro`.`pessoa`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ControleFinanceiro`.`pessoa` (
  ...
  `numer_celular` INT(12) NOT NULL,
  `telefone1` INT(12) NULL,
  `telefone2` INT(12) NULL,
  `email` VARCHAR(45) NOT NULL,
  `data_nascimento` DATE NOT NULL,
  `datetime_create` TIMESTAMP NOT NULL DEFAULT current_timestamp,
  `user_update` VARCHAR(45) NOT NULL,
  `last_update` TIMESTAMP NOT NULL DEFAULT current_timestamp on update current_timestamp,
  PRIMARY KEY (`id_pessoa`, `telefone_id`, `tipo_pessoa_id`, `endereco_id`),
  INDEX `fk_pessoa_telefone1_idx` (`telefone_id` ASC),
  ...
  CONSTRAINT `fk_pessoa_telefone1`
    ...
    REFERENCES `ControleFinanceiro`.`telefone` (`id_telefone`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_pessoa_endereco1`
    FOREIGN KEY (`endereco_id`)
    REFERENCES `ControleFinanceiro`.`endereco` (`id_endereco`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_pessoa_tipo_pessoa1`
    FOREIGN KEY (`tipo_pessoa_id`)
    REFERENCES `ControleFinanceiro`.`tipo_pessoa` (`id_tipo_pessoa`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `ControleFinanceiro`.`usuario` (
  ...
  CONSTRAINT `fk_usuario_pessoa1`
    ...
    REFERENCES `ControleFinanceiro`.`pessoa` (`id_pessoa`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `ControleFinanceiro`.`depesas_fixas` (
  ...
  `parcelas_pagas` VARCHAR(45) NULL,
  `status` ENUM('Paga', 'A pagar') NOT NULL DEFAULT 'A pagar',
  `user_update` VARCHAR(45) NOT NULL DEFAULT 'kaiuviny',
  `last_update` TIMESTAMP NOT NULL DEFAULT current_timestamp on update current_timestamp,
  PRIMARY KEY (`id_depesas_fixas`, `usuario_id`, `categoria_despesas_fixas_id`, `mes_id`),
  ...
  INDEX `fk_depesas_fixas_usuario1_idx` (`usuario_id` ASC),
  ...
  CONSTRAINT `fk_minhas_depesas_fixas_mes1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_depesas_fixas_usuario1`
    FOREIGN KEY (`usuario_id`)
    REFERENCES `ControleFinanceiro`.`usuario` (`id_usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `ControleFinanceiro`.`despesas_variaveis` (
  ...
  `user_update` VARCHAR(45) NOT NULL DEFAULT 'kaiuviny',
  `last_update` TIMESTAMP NOT NULL DEFAULT current_timestamp on update current_timestamp,
  PRIMARY KEY (`id_despesas_variaveis`, `usuario_id`, `mes_id_mes`, `categoria_despesas_variaveis_id`, `pagamento_despesas_variaveis_id`),
  ...
  INDEX `fk_despesas_variaveis_usuario1_idx` (`usuario_id` ASC),
  ...
  CONSTRAINT `fk_minhas_despesas_variaveis_categoria_despesas_fixas1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_despesas_variaveis_usuario1`
    FOREIGN KEY (`usuario_id`)
    REFERENCES `ControleFinanceiro`.`usuario` (`id_usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `ControleFinanceiro`.`ganhos` (
  ...
  `user_update` VARCHAR(45) NOT NULL DEFAULT 'kaiuviny',
  `last_update` TIMESTAMP NOT NULL DEFAULT current_timestamp on update current_timestamp,
  PRIMARY KEY (`id_ganhos`, `usuario_id`, `mes_id_mes`),
  INDEX `fk_ganhos_mes1_idx` (`mes_id_mes` ASC),
  INDEX `fk_ganhos_usuario1_idx` (`usuario_id` ASC),
  CONSTRAINT `fk_ganhos_mes1`
    FOREIGN KEY (`mes_id_mes`)
    REFERENCES `ControleFinanceiro`.`mes` (`id_mes`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ganhos_usuario1`
    FOREIGN KEY (`usuario_id`)
    REFERENCES `ControleFinanceiro`.`usuario` (`id_usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `ControleFinanceiro`.`pagamento_dividas` (
  ...
  `user_update` VARCHAR(45) NOT NULL DEFAULT 'kaiuviny',
  `last_update` TIMESTAMP NOT NULL DEFAULT current_timestamp on update current_timestamp,
  PRIMARY KEY (`id_pagamento_dividas`, `usuario_id`, `mes_id_mes`, `minhas_dividas_id`),
  INDEX `fk_pagamento_dividas_minhas_dividas1_idx` (`minhas_dividas_id` ASC),
  INDEX `fk_pagamento_dividas_mes1_idx` (`mes_id_mes` ASC),
  INDEX `fk_pagamento_dividas_usuario1_idx` (`usuario_id` ASC),
  ...
  CONSTRAINT `fk_pagamento_dividas_mes1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_pagamento_dividas_usuario1`
    FOREIGN KEY (`usuario_id`)
    REFERENCES `ControleFinanceiro`.`usuario` (`id_usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `ControleFinanceiro`.`valores_investimento` (
  ...
  `user_update` VARCHAR(45) NOT NULL DEFAULT 'kaiuviny',
  `last_update` TIMESTAMP NOT NULL DEFAULT current_timestamp on update current_timestamp,
  PRIMARY KEY (`id_valores_investimento`, `usuario_id`, `investimentos_id`, `mes_id`),
  INDEX `fk_valores_investimento_investimentos1_idx` (`investimentos_id` ASC),
  INDEX `fk_valores_investimento_mes1_idx` (`mes_id` ASC),
  INDEX `fk_valores_investimento_usuario1_idx` (`usuario_id` ASC),
  ...
  CONSTRAINT `fk_valores_investimento_mes1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_valores_investimento_usuario1`
    FOREIGN KEY (`usuario_id`)
    REFERENCES `ControleFinanceiro`.`usuario` (`id_usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `ControleFinanceiro`.`limite_gastos_categoria` (
  ...
  `user_update` VARCHAR(45) NOT NULL,
  `last_update` TIMESTAMP NOT NULL DEFAULT current_timestamp on update current_timestamp,
  PRIMARY KEY (`id_limite_gastos_categooria`, `usuario_id`, `categorias_id`),
  INDEX `fk_limite_gastos_categoria_categorias1_idx` (`categorias_id` ASC),
  INDEX `fk_limite_gastos_categoria_usuario1_idx` (`usuario_id` ASC),
  CONSTRAINT `fk_limite_gastos_categoria_categorias1`
    FOREIGN KEY (`categorias_id`)
    REFERENCES `ControleFinanceiro`.`categorias` (`id_categoria`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_limite_gastos_categoria_usuario1`
    FOREIGN KEY (`usuario_id`)
    REFERENCES `ControleFinanceiro`.`usuario` (`id_usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `ControleFinanceiro`.`estabelecimento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ControleFinanceiro`.`estabelecimento` (
...
-- -----------------------------------------------------
-- Table `ControleFinanceiro`.`produto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ControleFinanceiro`.`produto` (
  ...
  CONSTRAINT `fk_produto_categoria1`
    ...
    REFERENCES `ControleFinanceiro`.`categoria` (`id_categoria`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `ControleFinanceiro`.`wishlist` (
  ...
  CONSTRAINT `fk_wishlist_estabelecimento1`
    ...
    REFERENCES `ControleFinanceiro`.`estabelecimento` (`id_estabelecimento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_wishlist_produto1`
    FOREIGN KEY (`produto_id`)
    REFERENCES `ControleFinanceiro`.`produto` (`id_produto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `ControleFinanceiro`.`metas_financeiras` (
  ...
  PRIMARY KEY (`id_metas_financeiras`, `usuario_id`),
  INDEX `fk_metas_financeiras_usuario1_idx` (`usuario_id` ASC),
  CONSTRAINT `fk_metas_financeiras_usuario1`
    FOREIGN KEY (`usuario_id`)
    REFERENCES `ControleFinanceiro`.`usuario` (`id_usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `ControleFinanceiro`.`acesso`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ControleFinanceiro`.`acesso` (
...
-- -----------------------------------------------------
-- Table `ControleFinanceiro`.`usuario_has_acesso`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ControleFinanceiro`.`usuario_has_acesso` (
  `usuario_id` INT NOT NULL,
  ...
  CONSTRAINT `fk_usuario_has_acesso_acesso1`
    ...
    REFERENCES `ControleFinanceiro`.`acesso` (`id_acesso`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
